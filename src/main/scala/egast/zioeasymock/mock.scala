...
case class Mock1[A: Tagged](mock1: Task[A]) {
...
case class Mock2[A: Tagged, B: Tagged](mock1: Task[A], mock2: Task[B]) {
...
case class Mock3[A: Tagged, B: Tagged, C: Tagged](mock1: Task[A], mock2: Task[B], mock3: Task[C]) {
